...
colors = plt.get_cmap('tab20')(np.linspace(0, 1, num_grados))

# Crear el gráfico de barras con un frame más grande
plt.figure(figsize=(20, 10))  # Aumentar el tamaño de la figura para más espacio
...
plt.savefig("distribucion_matricula_grado.png")